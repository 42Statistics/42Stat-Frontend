...
export type GetPersonalEvalByLoginQuery = { __typename?: 'Query', getPersonalEval: { __typename?: 'PersonalEval', correctionPoint: number, totalCount: number, totalDuration: number, averageDuration: number, averageFinalMark: number, averageCommentLength: number, averageFeedbackLength: number, recentComment?: string | null, destinyRanking: Array<{ __typename?: 'UserRank', value: number, rank: number, userPreview: { __typename?: 'UserPreview', id: number, login: string, imgUrl?: string | null } }> } };

export type DesinyRankingFragmentFragment = { __typename?: 'PersonalEval', destinyRanking: Array<{ __typename?: 'UserRank', value: number, rank: number, userPreview: { __typename?: 'UserPreview', id: number, login: string, imgUrl?: string | null } }> };
...
export type CharacterFragmentFragment = { __typename?: 'PersonalGeneral', character?: { __typename?: 'Character', name: string, imgUrl: string, types: Array<{ __typename?: 'CharacterType', name: string, description: string, color: string }> } | null };
...
export const DesinyRankingFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"desinyRankingFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PersonalEval"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"destinyRanking"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"limit"},"value":{"kind":"IntValue","value":"5"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"userPreview"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"login"}},{"kind":"Field","name":{"kind":"Name","value":"imgUrl"}}]}},{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"rank"}}]}}]}}]} as unknown as DocumentNode<DesinyRankingFragmentFragment, unknown>;
