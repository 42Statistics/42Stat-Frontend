...
export type GetProjectInfoZeroCostByProjectNameQuery = { __typename?: 'Query', getProjectInfo: { __typename?: 'ProjectInfo', name: string, circle: number, url: string, description: string, minUserCount: number, maxUserCount: number, estimateTime?: string | null, difficulty?: number | null, objectives: Array<string>, skills: Array<string> } };
