...
export type LoginResult = NotLinked | Success;

export type Mutation = {
  __typename?: 'Mutation';
  deleteAccount: Scalars['Int'];
  linkGoogle: UserAccount;
  login: Success;
  loginGoogle: LoginResult;
  logout: Scalars['Int'];
  refreshToken: Success;
  unlinkGoogle: UserAccount;
};
...
export type NotLinked = {
  __typename?: 'NotLinked';
...
export type LoginGoogleMutation = { __typename?: 'Mutation', loginGoogle: { __typename: 'NotLinked', message: string } | { __typename: 'Success', message: string, accessToken: string, refreshToken: string, userId: number } };
...
export type LoginFtMutation = { __typename?: 'Mutation', login: { __typename?: 'Success', message: string, accessToken: string, refreshToken: string, userId: number } };
...
export type GetSettingQuery = { __typename?: 'Query', getSetting: { __typename?: 'Setting', account: { __typename?: 'Account', googleEmail?: string | null, linkedAt?: string | null } } };
...
export type GetNewAccessTokenMutation = { __typename?: 'Mutation', refreshToken: { __typename?: 'Success', message: string, accessToken: string, refreshToken: string, userId: number } };
...
export type LinkGoogleMutation = { __typename?: 'Mutation', linkGoogle: { __typename?: 'UserAccount', googleId: string, googleEmail: string, linkedAt: string, userId: number } };

export type UnlinkGoogleMutationVariables = Exact<{ [key: string]: never; }>;


export type UnlinkGoogleMutation = { __typename?: 'Mutation', unlinkGoogle: { __typename?: 'UserAccount', googleId: string, googleEmail: string, linkedAt: string, userId: number } };
...
export const LoginGoogleDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LoginGoogle"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"google"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"GoogleLoginInput"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ftCode"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"loginGoogle"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"google"},"value":{"kind":"Variable","name":{"kind":"Name","value":"google"}}},{"kind":"Argument","name":{"kind":"Name","value":"ftCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ftCode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Success"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"refreshToken"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"NotLinked"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<LoginGoogleMutation, LoginGoogleMutationVariables>;
...
export const LoginFtDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"LoginFt"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ftCode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"login"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ftCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ftCode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"accessToken"}},{"kind":"Field","name":{"kind":"Name","value":"refreshToken"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}}]}}]} as unknown as DocumentNode<LoginFtMutation, LoginFtMutationVariables>;
