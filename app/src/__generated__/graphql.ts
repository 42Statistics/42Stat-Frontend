...
export type GetCurrRegisteredCountRankingQuery = { __typename?: 'Query', getHomeTeam: { __typename?: 'HomeTeam', currRegisteredCountRanking: Array<{ __typename?: 'ProjectRanking', value: number, projectPreview: { __typename?: 'ProjectPreview', id: number, name: string } }> } };
...
export type GetEvalCountByDateTemplateQuery = { __typename?: 'Query', getHomeEval: { __typename?: 'HomeEval', currData: { __typename?: 'IntDateRanged', data: number, start: string, end: string }, lastData: { __typename?: 'IntDateRanged', data: number, start: string, end: string } } };
...
export type GetAverageCommentLengthByLoginQuery = { __typename?: 'Query', getPersonalEvalPage: { __typename?: 'PersonalEval', averageCommentLength: number } };
...
export type GetAverageFeedbackLengthByLoginQuery = { __typename?: 'Query', getPersonalEvalPage: { __typename?: 'PersonalEval', averageFeedbackLength: number } };
...
export type GetCorrectionPointQuery = { __typename?: 'Query', getPersonalEvalPage: { __typename?: 'PersonalEval', correctionPoint: number } };
...
export type GetEvalCountByDateTemplateByLoginQuery = { __typename?: 'Query', getPersonalEvalPage: { __typename?: 'PersonalEval', currData: { __typename?: 'IntDateRanged', data: number, start: string, end: string }, lastData: { __typename?: 'IntDateRanged', data: number, start: string, end: string } } };
...
export type GetTotalEvalCountByLoginQuery = { __typename?: 'Query', getPersonalEvalPage: { __typename?: 'PersonalEval', totalCount: number } };
...
export type GetCoalitionScoreQuery = { __typename?: 'Query', getPersonalGeneralPage: { __typename?: 'PersonalGeneral', userProfile: { __typename?: 'UserProfile', coalition: { __typename?: 'Coalition', id: number, name: string, slug: string, imageUrl?: string | null, coverUrl?: string | null, color?: string | null, score: number, userId: number } }, scoreInfo: { __typename?: 'UserScoreInfo', value: number, rankInCoalition: number } } };
...
export type GetLevelRecordsQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type GetLevelRecordsQuery = { __typename?: 'Query', getPersonalGeneralPage: { __typename?: 'PersonalGeneral', levelRecords: Array<{ __typename?: 'LevelRecord', after: number, userLevel: number, averageLevel: number }> } };
...
export type GetLogtimeByDateTemplateQuery = { __typename?: 'Query', getPersonalGeneralPage: { __typename?: 'PersonalGeneral', currData: { __typename?: 'IntDateRanged', data: number, start: string, end: string }, lastData: { __typename?: 'IntDateRanged', data: number, start: string, end: string } } };
...
export type GetPreferredClusterByDateTemplateQuery = { __typename?: 'Query', getPersonalGeneralPage: { __typename?: 'PersonalGeneral', preferredClusterByDateTemplate: { __typename?: 'PreferredClusterDateRanged', start: string, end: string, data: { __typename?: 'PreferredCluster', name?: string | null } } } };
...
export type GetWalletQuery = { __typename?: 'Query', getPersonalGeneralPage: { __typename?: 'PersonalGeneral', wallet: number } };
