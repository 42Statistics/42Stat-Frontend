...
export type HomeEval = {
  ...
  evalCountRecord: Array<IntRecord>;
};
...
export type HomeEvalEvalCountRecordArgs = {
  last: Scalars['Int'];
};
...
export type HomeTeam = {
  ...
  teamCloseRecord: Array<IntRecord>;
};
...
export type HomeTeamTeamCloseRecordArgs = {
  last: Scalars['Int'];
};
...
export type HomeUser = {
  ...
  blackholedCountRecord: Array<IntRecord>;
  blackholedRate: Rate;
...
export type HomeUserBlackholedCountRecordArgs = {
  last: Scalars['Int'];
};
...
export type PersonalEvalCountRecordArgs = {
  last: Scalars['Int'];
};
...
export type PersonalGeneralLogtimeRecordArgs = {
  last: Scalars['Int'];
};
...
export type Query = {
  ...
  /** @deprecated v0.7.0: 쿼리 이름 변경: 같은 기능을 하는 getSpotlight 을 사용하세요. */
...
export type GetSearchResultQuery = { __typename?: 'Query', getSearchResult: { __typename?: 'SearchResult', userPreviews: Array<{ __typename?: 'UserPreview', id: number, login: string, imgUrl?: string | null }>, projectPreviews: Array<{ __typename?: 'ProjectPreview', id: number, name: string, url: string, circle?: number | null }> } };
...
export type TeamUserPreviewFieldsFragment = { __typename?: 'TeamUserPreview', id: number, login: string, imgUrl?: string | null, occurrence: number, isLeader: boolean };
...
export type GetEvalCountRecordQueryVariables = Exact<{
  last: Scalars['Int'];
}>;


export type GetEvalCountRecordQuery = { __typename?: 'Query', getHomeEval: { __typename?: 'HomeEval', evalCountRecord: Array<{ __typename?: 'IntRecord', at: string, value: number }> } };
...
export type GetTeamCloseRecordQueryVariables = Exact<{
  last: Scalars['Int'];
}>;


export type GetTeamCloseRecordQuery = { __typename?: 'Query', getHomeTeam: { __typename?: 'HomeTeam', teamCloseRecord: Array<{ __typename?: 'IntRecord', at: string, value: number }> } };
...
export type GetBlackholedCountRecordQueryVariables = Exact<{
  last: Scalars['Int'];
}>;


export type GetBlackholedCountRecordQuery = { __typename?: 'Query', getHomeUser: { __typename?: 'HomeUser', blackholedCountRecord: Array<{ __typename?: 'IntRecord', at: string, value: number }> } };
...
export type GetPersonalGeneralZeroCostByLoginQuery = { __typename?: 'Query', getPersonalGeneral: { __typename?: 'PersonalGeneral', beginAt: string, blackholedAt?: string | null, wallet: number, teamInfo: { __typename?: 'UserTeamInfo', lastPassed?: string | null, lastRegistered?: string | null }, userProfile: { __typename?: 'UserProfile', coalition?: { __typename?: 'Coalition', id: number, name: string, slug: string, imageUrl: string, coverUrl: string, color: string, score: number, userId: number } | null }, scoreInfo: { __typename?: 'UserScoreInfo', value: number, rankInCoalition?: number | null } } };
...
export type GetCountRecordByLoginQueryVariables = Exact<{
  login: Scalars['String'];
  last: Scalars['Int'];
}>;


export type GetCountRecordByLoginQuery = { __typename?: 'Query', getPersonalEval: { __typename?: 'PersonalEval', countRecord: Array<{ __typename?: 'IntRecord', at: string, value: number }> } };
...
export type GetLogtimeRecordQueryVariables = Exact<{
  login: Scalars['String'];
  last: Scalars['Int'];
}>;


export type GetLogtimeRecordQuery = { __typename?: 'Query', getPersonalGeneral: { __typename?: 'PersonalGeneral', logtimeRecord: Array<{ __typename?: 'IntRecord', at: string, value: number }> } };
...
export type GetEvalCountByDateTemplateVersusQueryVariables = Exact<{
  login1: Scalars['String'];
  login2: Scalars['String'];
  dateTemplate: DateTemplate;
}>;
...
export type GetEvalCountByDateTemplateVersusQuery = { __typename?: 'Query', data1: { __typename?: 'PersonalEval', countByDateTemplate: { __typename?: 'IntDateRanged', data: number, start: string, end: string } }, data2: { __typename?: 'PersonalEval', countByDateTemplate: { __typename?: 'IntDateRanged', data: number, start: string, end: string } } };

export type GetLogtimeByDateTemplateVersusQueryVariables = Exact<{
  login1: Scalars['String'];
  login2: Scalars['String'];
  dateTemplate: DateTemplate;
}>;
...
export type GetLogtimeByDateTemplateVersusQuery = { __typename?: 'Query', data1: { __typename?: 'PersonalGeneral', logtimeByDateTemplate: { __typename?: 'IntDateRanged', data: number, start: string, end: string } }, data2: { __typename?: 'PersonalGeneral', logtimeByDateTemplate: { __typename?: 'IntDateRanged', data: number, start: string, end: string } } };
...
export type GetProjectInfoZeroCostByProjectNameQuery = { __typename?: 'Query', getProjectInfo: { __typename?: 'ProjectInfo', name: string, circle?: number | null, url: string, description: string, minUserCount: number, maxUserCount: number, estimateTime?: string | null, difficulty?: number | null, objectives: Array<string>, skills: Array<string> } };
...
export const GetEvalCountRecordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEvalCountRecord"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getHomeEval"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"evalCountRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"at"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<GetEvalCountRecordQuery, GetEvalCountRecordQueryVariables>;
...
export const GetTeamCloseRecordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetTeamCloseRecord"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getHomeTeam"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"teamCloseRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"at"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<GetTeamCloseRecordQuery, GetTeamCloseRecordQueryVariables>;
...
export const GetBlackholedCountRecordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetBlackholedCountRecord"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getHomeUser"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"blackholedCountRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"at"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<GetBlackholedCountRecordQuery, GetBlackholedCountRecordQueryVariables>;
...
export const GetCountRecordByLoginDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCountRecordByLogin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPersonalEval"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"countRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"at"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<GetCountRecordByLoginQuery, GetCountRecordByLoginQueryVariables>;
...
export const GetLogtimeRecordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLogtimeRecord"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getPersonalGeneral"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logtimeRecord"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"at"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]} as unknown as DocumentNode<GetLogtimeRecordQuery, GetLogtimeRecordQueryVariables>;
...
export const GetEvalCountByDateTemplateVersusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEvalCountByDateTemplateVersus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login1"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login2"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTemplate"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"data1"},"name":{"kind":"Name","value":"getPersonalEval"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login1"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"countByDateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dateTemplate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"data2"},"name":{"kind":"Name","value":"getPersonalEval"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login2"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"countByDateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dateTemplate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}}]}}]}}]}}]} as unknown as DocumentNode<GetEvalCountByDateTemplateVersusQuery, GetEvalCountByDateTemplateVersusQueryVariables>;
export const GetLogtimeByDateTemplateVersusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetLogtimeByDateTemplateVersus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login1"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"login2"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DateTemplate"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"data1"},"name":{"kind":"Name","value":"getPersonalGeneral"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login1"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logtimeByDateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dateTemplate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}}]}}]}},{"kind":"Field","alias":{"kind":"Name","value":"data2"},"name":{"kind":"Name","value":"getPersonalGeneral"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"login"},"value":{"kind":"Variable","name":{"kind":"Name","value":"login2"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"logtimeByDateTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"dateTemplate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"dateTemplate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"data"}},{"kind":"Field","name":{"kind":"Name","value":"start"}},{"kind":"Field","name":{"kind":"Name","value":"end"}}]}}]}}]}}]} as unknown as DocumentNode<GetLogtimeByDateTemplateVersusQuery, GetLogtimeByDateTemplateVersusQueryVariables>;
