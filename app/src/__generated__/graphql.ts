...
export type GetPersonalEvalByLoginQuery = { __typename?: 'Query', getPersonalEval: { __typename?: 'PersonalEval', correctionPoint: number, totalDuration: number, averageDuration: number, averageFinalMark: number, averageCommentLength: number, averageFeedbackLength: number, recentComment?: string | null } };
