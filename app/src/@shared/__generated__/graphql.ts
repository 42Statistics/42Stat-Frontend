...
export type GetFollowListsQueryVariables = Exact<{
  id: Scalars['Int'];
  pageSize: Scalars['Int'];
  pageNumber: Scalars['Int'];
}>;
...
export type GetFollowListsQuery = { __typename?: 'Query', getFollowingPaginated: { __typename?: 'MyFollowPaginated', totalCount: number, pageSize: number, pageNumber: number, nodes: Array<{ __typename?: 'MyFollow', isFollowing: boolean, followAt: string, userPreview: { __typename?: 'UserPreview', id: number, login: string, imgUrl?: string | null } }> }, getFollowerPaginated: { __typename?: 'MyFollowPaginated', totalCount: number, pageSize: number, pageNumber: number, nodes: Array<{ __typename?: 'MyFollow', isFollowing: boolean, followAt: string, userPreview: { __typename?: 'UserPreview', id: number, login: string, imgUrl?: string | null } }> } };

export type GetPersonalBlackholeQueryVariables = Exact<{
  login: Scalars['String'];
}>;


export type GetPersonalBlackholeQuery = { __typename?: 'Query', getPersonalGeneral: { __typename?: 'PersonalGeneral', blackholedAt?: string | null } };
