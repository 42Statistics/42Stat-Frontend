...
export type GetProjectIntroductionByProjectNameQueryVariables = Exact<{
  projectName: Scalars['String'];
}>;


export type GetProjectIntroductionByProjectNameQuery = { __typename?: 'Query', getProjectInfo: { __typename?: 'ProjectInfo', name: string, description: string } };
