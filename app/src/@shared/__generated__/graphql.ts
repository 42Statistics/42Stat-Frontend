...
export type GetProjectsQuery = { __typename?: 'Query', getSpotlight: { __typename?: 'Spotlight', projectPreviews: Array<{ __typename?: 'ProjectPreview', id: number, name: string, url: string, circle?: number | null }> } };
